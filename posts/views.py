...
def LikeView(request, pk):
    ...
    if user id is found in likes, clicking will remove the
    like and set liked to False.
    If user id is not found in likes, clicking will add the
    like and set liked to True.
    """
...
def ReviewLikeView(request, pk):
    ...
    if user id is found in votes, clicking will remove the
    like and set voted to False.
    If user id is not found in votes, clicking will add the
    like and set voted to True.
    """
